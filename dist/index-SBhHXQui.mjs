...
async function initMyMicroApp(app, options, router2, store) {
  ...
  const { initMicroApp } = await import("./initMicroApp-yRCg2-Ys.mjs");
  ...
  const { initMicroAppMessage } = await import("./index-DXyJmIcE.mjs");
...
export {
  ...
  microAppSetting$1 as c,
  getMainAppConfigs as d,
  getSubAppConfigs as e,
  initVueRouter as f,
  getAllApps as g,
  getRounterInstance as h,
  initMyMicroApp as i,
  appConfigs as j,
  microApp as m,
